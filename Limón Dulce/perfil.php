        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group profile-nav-tabs" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action" id="list-settings-list" data-bs-toggle="list" href="#list-orders" role="tab" aria-controls="list-orders">
                        <i class="bi bi-box-seam"></i> Mis Pedidos
                    </a>
                    <a class="list-group-item list-group-item-action text-danger" id="list-logout-list" href="#">
            ...
            <div class="col-md-9">
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-profile" role="tabpanel" aria-labelledby="list-home-list">
                        ...
                        <form action="tu_script_php_actualizar_perfil.php" method="POST">
                            <div class="mb-3">
                                <label for="userName" class="form-label">Nombre Completo</label>
                                <input type="text" class="form-control" id="userName" value="Juan Pérez" required>
                            </div>
                            <div class="mb-3">
                                <label for="userEmail" class="form-label">Correo Electrónico</label>
                                <input type="email" class="form-control" id="userEmail" value="juan.perez@example.com" required disabled>
                            </div>
                            <div class="mb-3">
                                <label for="userPhone" class="form-label">Teléfono</label>
                                <input type="tel" class="form-control" id="userPhone" value="+506 8888-8888">
                            </div>
                            <div class="mb-3">
                                <label for="userAddress" class="form-label">Dirección</label>
                                <input type="text" class="form-control" id="userAddress" value="Calle Principal 123, Ciudad Quesada, Costa Rica">
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary mt-auto">Guardar Cambios</button>
                        </form>
                    </div>

                    <div class="tab-pane fade" id="list-orders" role="tabpanel" aria-labelledby="list-settings-list">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn btn-sm btn-outline-info">Ver Detalles</a></td>
                                    </tr>
                                    <tr>
                                        <td>#LD002</td>
                                        <td>2025-08-01</td>
